...
(function($) {
    ...
    var DropdownView = function() {
        ...
        utils.mixin(DropdownView.prototype, EventTarget, {
            _handleMouseenter: function() {
                this._getSuggestions().removeClass('tt-highlighted');
            ...
            _handleMouseover: function($e) {
                ...
                $suggestion.removeClass('tt-highlighted');
    ...
    var TypeaheadView = function() {
        var html = {
            ...
            hint: '<input class="tt-hint" type="search" autocomplete="off" spellcheck="off" disabled>',
